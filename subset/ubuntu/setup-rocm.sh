...
case $OS_VERSION in 
    22.04)
        wget -qO amdgpu-install_all.deb https://repo.radeon.com/amdgpu-install/5.4.1/ubuntu/jammy/amdgpu-install_5.4.50401-1_all.deb >/dev/null
        ;;
    20.04)
        wget -qO amdgpu-install_all.deb https://repo.radeon.com/amdgpu-install/5.4.1/ubuntu/focal/amdgpu-install_5.4.50401-1_all.deb  >/dev/null
        ;;
esac
